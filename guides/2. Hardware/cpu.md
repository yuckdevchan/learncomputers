# CPU
[CPU](https://en.wikipedia.org/wiki/Central_processing_unit) stands for central processing unit.
...
- 'operand' - a parameter passed alongside the opcode.<br>Can be a memory address or a numerical value.
