...
ANI refers to AI bots trained to do a single, specific task.
### Artificial General Intelligence (AGI)
AGI refers to AI bots able to comprehensively match humans in various cognitive benchmarks.

Some people believe that AGI could engage in recursive self-improvement (developing itself) to produce superintelligence, or ASI.
### Artificial Superintelligence (ASI)
ASI refers to hypothetical AI bots which far surpass humans in terms of intellectual abilities.